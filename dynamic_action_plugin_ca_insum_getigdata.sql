...
--   Application:     135
--   Name:            plugin
--   Date and Time:   11:50 Tuesday March 15, 2022
...
'                    end',
'        ||     ''  apex.debug("igModel2.length: " + igModel2.length); '' || k_crlf',
'        ||     ''  let i = 0;''',
'        ||     l_js_val1  ',
...
,p_standard_attributes=>'REGION:REQUIRED:ONLOAD:WAIT_FOR_RESULT'
